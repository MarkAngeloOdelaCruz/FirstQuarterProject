...
function evaluation(a){
    if (a==5){
        return "Congratulations! You're very knowledgeable on SDG 11!";
    }
    else if(a>2){
        return "Good job! Just a few mistakes, but you know a lot about SDG 11!";
    }
    else if(a>0){
        return "Nice try! Try reviewing your mistakes and you'll improve!";
    }
    else{
        return "Better luck next time! Try researching more about SDG 11 to increase your knowledge!";
    }
}
